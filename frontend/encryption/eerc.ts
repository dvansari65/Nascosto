 ...
 */
export async function encryptAmount(amount: bigint | string, signer: ethers.Signer): Promise<string> {
  try {
    ...
    console.warn("AvaCloud eERC SDK not initialized. Using secure local mock for UI testing:", error);
